...
public class ScreenRecorder extends VlcjTest {
	...
	private static final String[] OPTIONS = { "--no-plugins-cache",
			"--no-video-title-show", "--quiet", "--quiet-synchro", "--intf",
			"dummy" };

	private static final String MRL = "screen://";
	private static final String SOUT = ":sout=#transcode{vcodec=FLV1e,vb=%d,scale=%f}:duplicate{dst=file{dst=%s}}";
	...
	public static void main(String[] args) {
		...
		final String destination = "record1.flv";
