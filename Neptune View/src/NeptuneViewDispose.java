 ...
 * @author ericzhu
 */
public class NeptuneViewDispose extends javax.swing.JFrame {

	/**
	 * Creates new form NeptuneView
	 */
	public NeptuneViewDispose() {
		initComponents();
		this.pack();
	...
	private void initComponents() {
		...
		desktop.setDebugGraphicsOptions(javax.swing.DebugGraphics.LOG_OPTION);
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(0, 1330,
				Short.MAX_VALUE));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(0, 610,
				Short.MAX_VALUE));

		jPanel1.setBounds(10, 10, 1330, 610);
		desktop.add(jPanel1, javax.swing.JLayeredPane.DRAG_LAYER);
		...
		jMenuItem4.setAccelerator(javax.swing.KeyStroke.getKeyStroke(
				...
				java.awt.event.InputEvent.CTRL_MASK));
		jMenuItem4.setText("Take Picture");
		...
		layout.setHorizontalGroup(layout.createParallelGroup(
				...
				layout.createSequentialGroup().addContainerGap().add(desktop)
						.addContainerGap()));
	...
	private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuItem1ActionPerformed
		JFileChooser fileChooser = new JFileChooser("Choose Image");
		...
		if (choose == javax.swing.JFileChooser.APPROVE_OPTION) {
			...
			if (file == null)
				return;
			NeptuneFrame NF = new NeptuneFrame(file.getAbsolutePath());
			desktop.add(NF, JLayeredPane.DEFAULT_LAYER);
			NF.setVisible(true);
	...
	private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuItem4ActionPerformed
		try {
			...
			ImageIO.write(Capture, "png", new File("TXE Screenshot.png"));
			JOptionPane
					.showMessageDialog(
							getParent(),
	...
	public static class ImageFilter extends javax.swing.filechooser.FileFilter {
	...
	public static void main(String args[]) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new NeptuneView().setVisible(true);
			}
		});
	}
